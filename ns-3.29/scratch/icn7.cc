...
int main (int argc, char *argv[])
{
	...
	//lteHelper->SetSchedulerType("ns3::IcnMacScheduler");
...
//		ulClient.SetAttribute ("MaxPackets", UintegerValue(1));
		...
		OnOffHelper onoff("ns3::UdpSocketFactory", InetSocketAddress(remoteHostAddr, ulPort));
		onoff.SetAttribute("DataRate", DataRateValue(DataRate("5Mbps")));
		clientApps = onoff.Install(ueNodes.Get(u));

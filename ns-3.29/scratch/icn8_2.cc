...
//	Time txWaitDelay = Seconds(3.0);
	...
	LogComponentEnable("IcnEchoServerApplication", LOG_LEVEL_FUNCTION);
...
//	}
	...
	/*
	 * Changes made to set the larger data load
	 *
	 */

//	echoServer.SetAttribute("DataRate", DataRate ("200Mb/s"));

 ...
 */
#ifndef ICN_REQUEST_RESPONSE_HELPER_H
#define ICN_REQUEST_RESPONSE_HELPER_H
 ...
 */
class IcnEchoServerHelper
{
public:
  /**
   * Create IcnEchoServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  IcnEchoServerHelper (uint16_t port);
 ...
 */
class IcnEchoClientHelper
{
public:
  /**
   * Create IcnEchoClientHelper which will make life easier for people trying
   ...
   */
  IcnEchoClientHelper (Address ip, uint16_t port);
  /**
   * Create IcnEchoClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  IcnEchoClientHelper (Address addr);

...
//
//  void WindowTraceCallback(Ptr<OutputStreamWrapper> stream, uint16_t guid, uint16_t rnti);
//  /*
//   * Enable Window traces that gives a table of GUID and RNTI
//   */
//  void EnableWindowTraces (void);

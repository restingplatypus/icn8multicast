 ...
 */
#ifndef ICN_ECHO_BULK_HELPER_H
#define ICN_ECHO_BULK_HELPER_H
 ...
 */
class IcnEchoBulkServerHelper
{
public:
  /**
   * Create IcnEchoBulkServerHelper which will make life easier for people trying
   * to set up simulations with echos.
   *
   * \param port The port the server will wait on for incoming packets
   */
  IcnEchoBulkServerHelper (uint16_t port);
 ...
 */
class IcnEchoBulkClientHelper
{
public:
  /**
   * Create IcnEchoBulkClientHelper which will make life easier for people trying
   ...
   */
  IcnEchoBulkClientHelper (Address ip, uint16_t port);
  /**
   * Create IcnEchoBulkClientHelper which will make life easier for people trying
   * to set up simulations with echos. Use this variant with addresses that do
   ...
   */
  IcnEchoBulkClientHelper (Address addr);

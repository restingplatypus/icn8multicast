...
void
LteStatsCalculator::SetWindowTraceFilename (std::string windowFileName)
{
	m_windowTraceFilename = windowFileName;
}

std::string
LteStatsCalculator::GetWindowTraceFilename (void)
{
	return m_windowTraceFilename;
}

...
void
MacStatsCalculator::SetWindowTraceFilename (std::string windowFileName)
{
	LteStatsCalculator::SetWindowTraceFilename (windowFileName);
}

std::string
MacStatsCalculator::GetWindowTraceFilename (void)
{
	return LteStatsCalculator::GetWindowTraceFilename ();
}
...
//void
//WindowTraceCallback (uint16_t guid, uint16_t rnti)
//{
//	//NS_LOG_FUNCTION (this << guid << rnti);
//	NS_LOG_INFO ("Write Window Trace Stats in " << MacStatsCalculator::GetWindowTraceFilename ().c_str ());
//
//	  std::ofstream outFile;
//	  if ( m_windowTraceFirstWrite == true )
//	    {
//	      outFile.open (GetWindowTraceFilename ().c_str ());
//	      if (!outFile.is_open ())
//	        {
//	          NS_LOG_ERROR ("Can't open file " << GetWindowTraceFilename ().c_str ());
//	          return;
//	        }
//	      m_windowTraceFirstWrite = false;
//	      outFile << "% time\tGUID\tRNTI";
//	      outFile << std::endl;
//	    }
//	  else
//	    {
//	      outFile.open (GetWindowTraceFilename ().c_str (),  std::ios_base::app);
//	      if (!outFile.is_open ())
//	        {
//	          NS_LOG_ERROR ("Can't open file " << GetWindowTraceFilename ().c_str ());
//	          return;

...
//void
//LteHelper::WindowTraceCallback(Ptr<OutputStreamWrapper> stream, uint16_t guid, uint16_t rnti)
//{
...
//
//void
//LteHelper::EnableWindowTraces(void)
//{
//	NS_LOG_FUNCTION_NOARGS();
//
//	AsciiTraceHelper asciiTraceHelper;
//	Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("icn8_1_window.out");
//	Config::Connect("/NodeList/*/DeviceList/*/ComponentCarrierMap/*/LteEnbMac/AxRnti", MakeBoundCallback (&WindowTraceCallback, stream ));
////	Config::Connect("/NodeList/*/DeviceList/*/ComponentCarrierMap/*/LteEnbMac/AxRnti",
////			MakeBoundCallback (&MacStatsCalculator::WindowTraceCallback, m_macStats));
//}

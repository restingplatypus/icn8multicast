...
#ifndef ICN_MAC_SCHEDULER_H
#define ICN_MAC_SCHEDULER_H
...
class IcnMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
  ...
  /// allow MemberCschedSapProvider<IcnMacScheduler> class friend access
  friend class MemberCschedSapProvider<IcnMacScheduler>;
  /// allow MemberSchedSapProvider<IcnMacScheduler> class friend access
  friend class MemberSchedSapProvider<IcnMacScheduler>;

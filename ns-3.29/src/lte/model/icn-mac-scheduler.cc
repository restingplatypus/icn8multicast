...
NS_LOG_COMPONENT_DEFINE ("IcnMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (IcnMacScheduler);


IcnMacScheduler::IcnMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new MemberCschedSapProvider<IcnMacScheduler> (this);
  m_schedSapProvider = new MemberSchedSapProvider<IcnMacScheduler> (this);
}
...
TypeId
IcnMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::IcnMacScheduler")
    .SetParent<FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<IcnMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&IcnMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (false),
                   MakeBooleanAccessor (&IcnMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&IcnMacScheduler::m_ulGrantMcs),
...
void
IcnMacScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
IcnMacScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
IcnMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
IcnMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
IcnMacScheduler::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
IcnMacScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
IcnMacScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
IcnMacScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
...
void
IcnMacScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
IcnMacScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
IcnMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
IcnMacScheduler::SortRlcBufferReq (FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,FfMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
uint8_t
IcnMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
IcnMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
IcnMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
//void GroupUeImsi(std::list <FfMacSchedSapProvider::SchedDlRlcBufferReqParameters> rlcBuffer)
//{
//	//std::vector<uint64_t> imsiValues{2,3};
//
//	for(std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it = rlcBuffer.begin(); it != rlcBuffer.end(); it++)
//	{
//		uint64_t imsi = (*it).imsi;
//		if (imsi == 2 || imsi == 3)
//		{
//			rlcBuffer.erase(it);
//		}
...
void
IcnMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
...
//    }
  ...
  //GroupUeImsi( &m_rlcBufferReq);
  for(std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator its = m_rlcBufferReq.begin(); its != m_rlcBufferReq.end(); its++)
  	{
  		uint64_t imsi = (*its).imsi;
  		if (imsi == 2 || imsi == 3)
  		{
  			m_rlcBufferReq.erase(its);
  		}
...
void
IcnMacScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoSchedUlTriggerReq (const struct FfMacSchedSapProvider::SchedUlTriggerReqParameters& params)
{
...
void
IcnMacScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
IcnMacScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
IcnMacScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
IcnMacScheduler::RefreshDlCqiMaps (void)
{
...
void
IcnMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
IcnMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
IcnMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
IcnMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{

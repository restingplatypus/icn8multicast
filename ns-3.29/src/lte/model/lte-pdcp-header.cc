...
LtePdcpHeader::LtePdcpHeader ()
  : m_dcBit (0xff), // 0xff means hexadecimal number FF which has integer value of 255. Further, 2^8 is 256. So, it effectively is the size of m_dcBit.
...
void
LtePdcpHeader::SetData(uint16_t data)
{
	m_data = data & 0x0FFF;
}
